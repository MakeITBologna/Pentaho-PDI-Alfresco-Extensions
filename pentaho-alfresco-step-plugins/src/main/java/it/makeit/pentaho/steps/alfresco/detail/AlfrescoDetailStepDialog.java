...
public class AlfrescoDetailStepDialog extends BaseStepDialog implements StepDialogInterface {

	private static Class<?> PKG = AlfrescoDetailStepMeta.class; // for i18n purposes

	private AlfrescoDetailStepMeta meta;
	...
	private LabelCombo wDetail;
	private LabelCombo wCmisFile;
	private LabelCombo wCmisFileType;

	private String[] cmisFileTypes = new String[] {
    		BaseMessages.getString( PKG, "AlfrescoDetailStep.ui.cmisFileTypePath" ),  
    		BaseMessages.getString( PKG, "AlfrescoDetailStep.ui.cmisFileTypeObjectId" ) 
    	};
	
	public AlfrescoDetailStepDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
		super(parent, (BaseStepMeta) in, transMeta, sname);
		meta = (AlfrescoDetailStepMeta) in;
	}
	...
	public String open() {
	    ...
	    shell.setText( BaseMessages.getString( PKG, "AlfrescoDetailStep.ui.title" ) );
	    ...
	    alfrescoGroup.setText(BaseMessages.getString( PKG, "AlfrescoDetailStep.ui.groupAlfresco" ));
	    ...
	    fdDetail.left = new FormAttachment( 0, 0 );
	    fdDetail.right = new FormAttachment( 100, 0 );
	    fdDetail.top = new FormAttachment( wCmisPassword, margin );
	    wDetail.setLayoutData( fdDetail );
	    ...
	    fdCmisFile.top = new FormAttachment( wDetail, margin );
	    wCmisFile.setLayoutData( fdCmisFile );
	    
	    // RIGA CMIS DIRECTORY Type
		wCmisFileType = new LabelCombo( alfrescoGroup, SWT.READ_ONLY, BaseMessages.getString( PKG, "AlfrescoDetailStep.ui.cmisFileType" ), null );
	    ...
	    wDetail.addSelectionListener( lsDef );
	...
	private void ok() {
		...
		meta.setDetail(!Strings.isNullOrEmpty(wDetail.getText()) ? wDetail.getText() : null);
	...
	private void setFieldValues() {
		...
		if( meta.getDetail() != null  ) 	wDetail.setText( meta.getDetail() );
